...
//
// kList's file-row/mode-header sizing and the hint bar/menu-title bump on
// the 397 board go further than these four base roles - see
// ui_epaper_layout.h, a dedicated 397-only override so that layer of
// sizing never touches the 154 board's UI.
